...
class ResumeAPI:
    ...
    def register(self, username: str, password: str, email: str, github: str = "") -> Dict[str, Any]:
        """Register new user"""
        try:
            response = requests.post(
    ...
    def get_my_resumes(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.get(
                f"{self.base_url}/resumes/my-resumes",
                headers=headers
            )
            ...
            if response.status_code == 200:
                ...
                return {"success": False, "error": response.json().get("detail", "Failed to get resumes")}
