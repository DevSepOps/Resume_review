...
class ResumeApp:
    ...
    def main(self, page: ft.Page):
        ...
        self.upload_btn = ft.ElevatedButton(
            "Upload Resume", on_click=self.upload_clicked
        )
        ...
        self.refresh_btn = ft.ElevatedButton(
            "Refresh Resumes", on_click=self.refresh_resumes
        )
            ...
            ft.Column(
                [
                    ft.Row(
                        [
                            ft.Text(
                                "Resume Review App", size=24, weight=ft.FontWeight.BOLD
                            ),
                            self.logout_btn,
                        ],
    ...
    def upload_clicked(self, e):
        ...
        self.file_picker.pick_files(
            allowed_extensions=["pdf"], type=ft.FilePickerFileType.CUSTOM
        )
                            ...
                            content=ft.Container(
                                content=ft.Column(
                                    [
                                        ...
                                        ft.Text(
                                            f"Size: {resume.get('file_size', 0)} bytes"
                                        ),
                                        ft.Text(
                                            f"Uploaded: {resume.get('upload_date', 'N/A')}"
                                        ),
                                    ]
                                ),
                                padding=10,
